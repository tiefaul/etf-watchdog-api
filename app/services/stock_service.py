...
class Stock:
    ...
    async def get_price_by_date(self, date: str, symbol: str, api_key: str):
        ...
        logger.debug("Running get_price_by_date function.")
    ...
    async def get_current_price(self, symbol: str, api_key: str):
        ...
        # Make request to the api
        logger.debug("Running get_current_price function.")
        output = await self.stock_data_requests(symbol=symbol, price=True, api_key=api_key)
